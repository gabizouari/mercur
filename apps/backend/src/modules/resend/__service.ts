...
import { newSellerInvitation } from "./emails/new-seller-invitation";

enum Templates {
  ORDER_PLACED = "order-placed",
  USER_INVITED = "user-invited",
  PASSWORD_RESET = "password-reset",
  NEW_SELLER_INVITATION = "new-seller-invitation"
}
...
const templates: {[key in Templates]?: (props: unknown) => React.ReactNode} = {
  ...
  [Templates.NEW_SELLER_INVITATION]: newSellerInvitation
}
